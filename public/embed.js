(function () {
  ...
  style.textContent = [
    ".n22-bubble{position:fixed;bottom:24px;z-index:2147483646;width:60px;height:60px;border-radius:50%;border:none;cursor:pointer;display:flex;align-items:center;justify-content:center;box-shadow:0 4px 20px rgba(0,0,0,0.18),0 1px 4px rgba(0,0,0,0.1);transition:transform .2s cubic-bezier(.22,1,.36,1),box-shadow .2s ease;}",
    ".n22-bubble:hover{transform:scale(1.08);box-shadow:0 6px 28px rgba(0,0,0,0.22),0 2px 6px rgba(0,0,0,0.12);}",
    ".n22-bubble:active{transform:scale(0.95);}",
    ".n22-bubble svg{transition:transform .3s cubic-bezier(.22,1,.36,1);}",
    ".n22-bubble[data-open='true'] svg{transform:rotate(90deg);}",
    ".n22-panel{position:fixed;bottom:100px;z-index:2147483647;width:400px;height:min(680px,calc(100vh - 140px));border-radius:20px;overflow:hidden;box-shadow:0 24px 80px rgba(0,0,0,0.15),0 4px 16px rgba(0,0,0,0.08);border:1px solid rgba(0,0,0,0.06);opacity:0;transform:translateY(16px) scale(0.96);pointer-events:none;transition:opacity .3s cubic-bezier(.22,1,.36,1),transform .3s cubic-bezier(.22,1,.36,1);}",
    ".n22-panel[data-open='true']{opacity:1;transform:translateY(0) scale(1);pointer-events:auto;}",
    ".n22-panel iframe{width:100%;height:100%;border:none;border-radius:20px;}",
    ...
    "  .n22-panel{width:calc(100vw - 24px);height:calc(100vh - 140px);bottom:96px;left:12px!important;right:12px!important;border-radius:16px;}",
    "  .n22-bubble{bottom:20px;width:54px;height:54px;}",
    "}",
  ].join("\n");
